...
#define THES_POLIS_WARNINGS_PUSH_gcc(...) \
  _Pragma("GCC diagnostic push") \
    THES_POLIS_PRAGMA_CLANG("clang diagnostic ignored \"-Wunknown-warning-option\"") \
      BOOST_PP_LIST_FOR_EACH(THES_POLIS_WARNINGS_OP_GCC, BOOST_PP_EMPTY(), \
                             BOOST_PP_VARIADIC_TO_LIST(__VA_ARGS__))
#define THES_POLIS_WARNINGS_POP_gcc(...) _Pragma("GCC diagnostic pop")
#else
#define THES_POLIS_WARNINGS_PUSH_gcc(...)
#define THES_POLIS_WARNINGS_POP_gcc(...)
#endif

#define THES_POLIS_WARNINGS_PUSH(COMPILER, ...) THES_POLIS_WARNINGS_PUSH_##COMPILER(__VA_ARGS__)
#define THES_POLIS_WARNINGS_POP(COMPILER) THES_POLIS_WARNINGS_POP_##COMPILER()
