...
#define THES_POLIS_STATIC_MEMBERS_FILTER_PRED_LAYOUT_INFO(...) 0
...
#define THES_POLIS_MEMBERS_FILTER_PRED_LAYOUT_INFO(...) 0
...
#define THES_POLIS_TEMPLATE_PARAMS_FILTER_PRED_LAYOUT_INFO(...) 0
...
#define THES_POLIS_BODY_FILTER_PRED_LAYOUT_INFO(...) 0

#define THES_POLIS_LAYOUT_INFO_FILTER_PRED_STATIC_MEMBERS(...) 0
#define THES_POLIS_LAYOUT_INFO_FILTER_PRED_MEMBERS(...) 0
#define THES_POLIS_LAYOUT_INFO_FILTER_PRED_TEMPLATE_PARAMS(...) 0
#define THES_POLIS_LAYOUT_INFO_FILTER_PRED_BODY(...) 0
#define THES_POLIS_LAYOUT_INFO_FILTER_PRED_LAYOUT_INFO(...) 1
...
#define THES_POLIS_ANY_MEMBERS_FILTER_OP_LAYOUT_INFO(...) __VA_ARGS__
...
#define THES_POLIS_BOOL_true 1
#define THES_POLIS_BOOL_false 0
#define THES_POLIS_BOOL(VAL) THES_POLIS_BOOL_##VAL
#define THES_POLIS_FOLD_AND(REC, STATE, ELEM) BOOST_PP_AND(STATE, THES_POLIS_BOOL(ELEM))
#define THES_POLIS_INCLUDE_LAYOUT_INFO(LIST) \
  BOOST_PP_BOOL(BOOST_PP_LIST_FOLD_LEFT(THES_POLIS_FOLD_AND, 1, \
                                        THES_POLIS_ANY_MEMBERS_FILTER(LAYOUT_INFO, LIST)))
...
#define THES_DEFINE_GENERATE_IMPL(IMPL, TYPE, CONSTRUCTOR, LIST) \
  THES_APPLY(IMPL, TYPE, THES_POLIS_NAME(TYPE), CONSTRUCTOR, \
             ...
             THES_POLIS_ANY_MEMBERS_FILTER(BODY, LIST), THES_POLIS_INCLUDE_LAYOUT_INFO(LIST))

#define THES_DEFINE_TYPE(TYPE, CONSTRUCTOR, ...) \
  THES_DEFINE_GENERATE_IMPL(THES_DEFINE_TYPE_IMPL, TYPE, CONSTRUCTOR, \
                            BOOST_PP_VARIADIC_TO_LIST(__VA_ARGS__))

#define THES_CREATE_TYPE(TYPE, CONSTRUCTOR, ...) \
  THES_DEFINE_GENERATE_IMPL(THES_CREATE_TYPE_IMPL, TYPE, CONSTRUCTOR, \
                            BOOST_PP_VARIADIC_TO_LIST(__VA_ARGS__))
