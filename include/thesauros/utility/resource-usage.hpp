#ifndef INCLUDE_THESAUROS_UTILITY_RESOURCE_USAGE_HPP
#define INCLUDE_THESAUROS_UTILITY_RESOURCE_USAGE_HPP
...
#endif // INCLUDE_THESAUROS_UTILITY_RESOURCE_USAGE_HPP
