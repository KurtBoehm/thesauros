...
int main() {
  ...
  };
  {
    static constexpr auto index_pos =
      make_index_pos(0, thes::static_value<thes::IterDirection::BACKWARD>);
  ...
  {
    static constexpr auto index_pos =
      make_index_pos(16, thes::static_value<thes::IterDirection::BACKWARD>);
    static_assert(ms.index_to_pos(index_pos.index) == index_pos.position);
    static_assert(index_pos.position == std::array{6_uz, 7_uz, 3_uz});
  }
  {
    static constexpr auto index_pos =
      make_index_pos(16, thes::static_value<thes::IterDirection::FORWARD>);
    static_assert(ms.index_to_pos(index_pos.index) == index_pos.position);
